...
имя_скрипта -c имя_конфигурационного_файла -f список_файлов_для_обработки [параметры] 
...
список_файлов_для_обработки – список xml-файлов, из которых нужно извлечь текст.
